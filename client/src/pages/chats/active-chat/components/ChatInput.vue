<template>
    <v-form style="display: inline-flex; margin: 0 5px -25px 0; width: 100%; padding: 0 19px 0 0;" @submit.prevent="onMessageSent">
        <v-text-field v-model="text" outlined style="padding: 10px;"/>
